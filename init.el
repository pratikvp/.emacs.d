...
(use-package my-util
  ...
  (("C-c u a" . m/add-include)
   ...
   ("C-c u d" . m/lookup-current-word)
   ("<f8>" . m/toggle-tab-width-setting)
   ("C-c u s" . m/search-all-buffers)
   ("C-c u k ." . m/kill-where-i-am)
   ("C-c u k g" . m/kill-where-i-am-relative-to-gitroot)
   ("C-c u g" . m/grep-what-im-on)
   ("C-c u k l" . m/kill-last-message)
   ("C-c u x" . m/xdg-open-each-in-region)
   ("C-c u z" . m/shell-here)
   ("C-c u i" . m/go-to-corresponding-header-or-implementation-file)
   ("C-c u r" . m/recompile)
   ("C-c u m `" . m/open-compilation-buffer)
   ("C-c u o" . m/occur-region-or-symbol-at-point)
   ("C-c u C-x C-e" . eval-and-replace)
   ("C-h e" . m/view-and-switch-to-echo-area-messages)
   ("C-c u M-/" . m/expand-file-name-at-point)
   ("C-v" . m/smooth-scroll-down)
   ("M-v" . m/smooth-scroll-up)
   ("C-c u u" . m/underline-previous-line)
   ("C-c u C-y" . m/get-primary)
   ("C-c u e" . er/expand-region)
